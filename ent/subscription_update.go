...
func (su *SubscriptionUpdate) SetLastLandmark(s string) *SubscriptionUpdate {
	su.mutation.SetLastLandmark(s)
	return su
}

// SetNillableLastLandmark sets the "last_landmark" field if the given value is not nil.
func (su *SubscriptionUpdate) SetNillableLastLandmark(s *string) *SubscriptionUpdate {
	if s != nil {
		su.SetLastLandmark(*s)
	}
	return su
}

// ClearLastLandmark clears the value of the "last_landmark" field.
func (su *SubscriptionUpdate) ClearLastLandmark() *SubscriptionUpdate {
	su.mutation.ClearLastLandmark()
	return su
}

// SetLastUpdate sets the "last_update" field.
func (su *SubscriptionUpdate) SetLastUpdate(t time.Time) *SubscriptionUpdate {
	su.mutation.SetLastUpdate(t)
	return su
}

// SetNillableLastUpdate sets the "last_update" field if the given value is not nil.
func (su *SubscriptionUpdate) SetNillableLastUpdate(t *time.Time) *SubscriptionUpdate {
	if t != nil {
		su.SetLastUpdate(*t)
	}
	return su
...
func (su *SubscriptionUpdate) ClearLastUpdate() *SubscriptionUpdate {
	su.mutation.ClearLastUpdate()
	return su
}
...
func (su *SubscriptionUpdate) SetNillableUsername(s *string) *SubscriptionUpdate {
	if s != nil {
		su.SetUsername(*s)
	}
	return su
...
func (su *SubscriptionUpdate) ClearUsername() *SubscriptionUpdate {
...
func (su *SubscriptionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.LastLandmark(); ok {
	...
	if su.mutation.LastLandmarkCleared() {
	...
	if su.mutation.LastUpdateCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Column: subscription.FieldLastUpdate,
		})
...
// SetLastLandmark sets the "last_landmark" field.
func (suo *SubscriptionUpdateOne) SetLastLandmark(s string) *SubscriptionUpdateOne {
	suo.mutation.SetLastLandmark(s)
	return suo
}

// SetNillableLastLandmark sets the "last_landmark" field if the given value is not nil.
func (suo *SubscriptionUpdateOne) SetNillableLastLandmark(s *string) *SubscriptionUpdateOne {
	if s != nil {
		suo.SetLastLandmark(*s)
	}
	return suo
}

// ClearLastLandmark clears the value of the "last_landmark" field.
func (suo *SubscriptionUpdateOne) ClearLastLandmark() *SubscriptionUpdateOne {
	suo.mutation.ClearLastLandmark()
	return suo
}

// SetLastUpdate sets the "last_update" field.
func (suo *SubscriptionUpdateOne) SetLastUpdate(t time.Time) *SubscriptionUpdateOne {
	suo.mutation.SetLastUpdate(t)
	return suo
}

// SetNillableLastUpdate sets the "last_update" field if the given value is not nil.
func (suo *SubscriptionUpdateOne) SetNillableLastUpdate(t *time.Time) *SubscriptionUpdateOne {
	if t != nil {
		suo.SetLastUpdate(*t)
	}
	return suo
...
// ClearLastUpdate clears the value of the "last_update" field.
func (suo *SubscriptionUpdateOne) ClearLastUpdate() *SubscriptionUpdateOne {
	suo.mutation.ClearLastUpdate()
	return suo
}
...
// SetNillableUsername sets the "username" field if the given value is not nil.
func (suo *SubscriptionUpdateOne) SetNillableUsername(s *string) *SubscriptionUpdateOne {
	if s != nil {
		suo.SetUsername(*s)
	}
	return suo
...
// ClearUsername clears the value of the "username" field.
func (suo *SubscriptionUpdateOne) ClearUsername() *SubscriptionUpdateOne {
...
func (suo *SubscriptionUpdateOne) sqlSave(ctx context.Context) (_node *Subscription, err error) {
	...
	if value, ok := suo.mutation.LastLandmark(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: subscription.FieldLastLandmark,
	...
	if suo.mutation.LastLandmarkCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: subscription.FieldLastLandmark,
		})
	...
	if suo.mutation.LastUpdateCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Column: subscription.FieldLastUpdate,
		})
