...
func (m *AuthorMutation) SetUserID(s string) {
	m.user_id = &s
}

// UserID returns the value of the "user_id" field in the mutation.
func (m *AuthorMutation) UserID() (r string, exists bool) {
	v := m.user_id
	if v == nil {
		return
	}
...
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthorMutation) OldUserID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AuthorMutation) SetUserName(s string) {
	m.user_name = &s
}

// UserName returns the value of the "user_name" field in the mutation.
func (m *AuthorMutation) UserName() (r string, exists bool) {
	v := m.user_name
	if v == nil {
		return
	}
...
// OldUserName returns the old "user_name" field's value of the Author entity.
// If the Author object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthorMutation) OldUserName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AuthorMutation) ResetUserName() {
	m.user_name = nil
}
...
func (m *AuthorMutation) Fields() []string {
	...
	if m.user_name != nil {
		fields = append(fields, author.FieldUserName)
	}
	return fields
}
