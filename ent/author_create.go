...
func (ac *AuthorCreate) SetUserID(s string) *AuthorCreate {
	ac.mutation.SetUserID(s)
	return ac
}

// SetUserName sets the "user_name" field.
func (ac *AuthorCreate) SetUserName(s string) *AuthorCreate {
...
func (ac *AuthorCreate) check() error {
	...
	if _, ok := ac.mutation.UserName(); !ok {
		return &ValidationError{Name: "user_name", err: errors.New(`ent: missing required field "Author.user_name"`)}
	}
	return nil
}
